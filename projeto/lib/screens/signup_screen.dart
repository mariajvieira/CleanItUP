...
class _SignUpState extends State<SignUp> {
  ...
  void signup() async {
    ...
    if (password.text.isEmpty || confirm_password.text.isEmpty || password.text != confirm_password.text) {
      setErrorMessage("Passwords do not match");
      return;
    }
    ...
    setErrorMessage(e.message ?? "An error occurred. Please check logs.");
    }
  }
